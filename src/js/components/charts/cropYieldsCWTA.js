...
const debug = debugFactory('app:components:CropYieldsCWTA');

var CropYieldsCWTA = React.createClass({
    ...
    render() {
        return (
            <div className={"col-xs-12"} id="cropYieldsChartCWTA">
                <h4>Crop Yields</h4>
                <span className={"text-muted"}>Crop yields in Terms of CWT / Acre</span>
